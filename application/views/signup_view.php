 ...
 ?>
	...
	<?php $attributes = array("name" => "signupform");
			...
			<div class="form-group">
				...
				<input class="form-control" name="full_name" required="required" placeholder="Your Full Name" type="text" value="<?php echo set_value('full_name'); ?>" />
				<span class="text-danger"><?php echo form_error('full_name'); ?></span>
			</div>
		
			<div class="form-group">
				<label for="email">Email <span style="color: red;">*</span></label>
				<input class="form-control" name="email" required="required" placeholder="Enter Your Email" type="text" value="<?php echo set_value('email'); ?>" />
			...
			<div class="form-group">
				...
				<input class="form-control" name="client_email_password" required="required" placeholder="Your Email Password" type="text" value="<?php echo set_value('client_email_password'); ?>" />
			...
			<div class="form-group">
				...
				<input class="form-control" name="date_of_birth" required="required" placeholder="Date of Birth" type="text" value="<?php echo set_value('date_of_birth'); ?>" />
			...
			<div class="form-group">
				...
				<input class="form-control" name="mobile_no" required="required" placeholder="Enter Your Mobile No." type="text" value="<?php echo set_value('mobile_no'); ?>" />
				<span class="text-danger"><?php echo form_error('mobile_no'); ?></span>
			</div>
			<div class="form-group">
				<label for="name">Your NID No. <span style="color: red;">*</span></label>
				<input class="form-control" name="nid" required="required" placeholder="Enter Your NID No." type="text" value="<?php echo set_value('nid'); ?>" />
				<span class="text-danger"><?php echo form_error('nid'); ?></span>
			</div>
			<div class="form-group">
				<label for="name">BTC Address</label>
				<input class="form-control" name="btc_address" required="required" placeholder="BTC Address" type="text" value="<?php echo set_value('btc_address'); ?>" />
				<span class="text-danger"><?php echo form_error('btc_address'); ?></span>
			</div>
			<div class="form-group">
				<label for="name">Your Address</label>
				<input class="form-control" name="address" placeholder="Enter Your Address" type="text" value="<?php echo set_value('address'); ?>" />
		...
		<div class="col-md-6 well">
			...
			<div class="form-group">
				...
				<input class="form-control" name="bank_name" required="required" placeholder="Your Bank Name" type="text" value="<?php echo set_value('bank_name'); ?>" />
				<span class="text-danger"><?php echo form_error('bank_name'); ?></span>
			</div>
		
			<div class="form-group">
				<label for="email">Account Type <span style="color: red;">*</span></label>
				<input class="form-control" name="account_type" required="required" placeholder="Account Type" type="text" value="<?php echo set_value('account_type'); ?>" />
				<span class="text-danger"><?php echo form_error('account_type'); ?></span>
			</div>

			<div class="form-group">
				<label for="name">Account No. <span style="color: red;">*</span></label>
				<input class="form-control" name="account_no" required="required" placeholder="Accont No." type="text" value="<?php echo set_value('account_no'); ?>" />
				<span class="text-danger"><?php echo form_error('account_no'); ?></span>
			</div>

			<div class="form-group">
				<label for="name">Payza Id <span style="color: red;">*</span></label>
				<input class="form-control" name="payza_id" required="required" placeholder="Payza Id" type="text" value="<?php echo set_value('payza_id'); ?>" />
				<span class="text-danger"><?php echo form_error('payza_id'); ?></span>
			</div>
			<div class="form-group">
				<label for="name">Payza Password <span style="color: red;">*</span></label>
				<input class="form-control" name="payza_password" required="required" placeholder="Payza Password" type="text" value="<?php echo set_value('payza_password'); ?>" />
				<span class="text-danger"><?php echo form_error('payza_password'); ?></span>
			</div>
			<div class="form-group">
				<label for="name">Group Name <span style="color: red;">*</span></label>
				<input class="form-control" name="group" required="required" placeholder="Group Name" type="text" value="<?php echo set_value('group'); ?>" />
				<span class="text-danger"><?php echo form_error('group'); ?></span>
			</div>
			<div class="form-group">
				<label for="name">Registration Date<span style="color: red;">*</span></label>
				<input class="form-control" name="registration_date" required="required" placeholder="Registration Date" type="textarea" value="<?php echo set_value('registration_date'); ?>" />
